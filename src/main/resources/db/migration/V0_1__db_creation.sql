...
(
    ...
    REFERENCES `account-micro`.`account`
(
    `id`
)
    )
...
(
    ...
    INDEX `FK_role_id_ACCOUNT_ROLE_id`
(
    `role_id` ASC
) VISIBLE,
...
(
    ...
    REFERENCES `account-micro`.`account_role`
(
    `id`
),
...
(
    ...
    UNIQUE INDEX `UK_name`
(
    `name` ASC
) VISIBLE,
    UNIQUE INDEX `UK_value`
(
    `name` ASC
) VISIBLE
    )
...
(
    ...
    INDEX `FK_role_id_PERMISSION_id`
(
    `permission_id` ASC
) VISIBLE,
...
(
    ...
    REFERENCES `account-micro`.`permission`
(
    `id`
),
